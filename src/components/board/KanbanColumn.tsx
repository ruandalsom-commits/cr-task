...
export function KanbanColumn({ column, children }: { column: any, children: ReactNode }) {
  ...
  return (
    <div className="flex flex-col w-[300px] shrink-0">
      <div className={`bg-white rounded-t-lg rounded-b-md shadow-sm border border-slate-200 border-t-4 ${borderColor} p-4 mb-3 flex justify-between items-center`}>
      ...
      <div 
        ref={setNodeRef} 
        className="flex-1 rounded-lg bg-slate-200/50 p-2 min-h-[500px]"
      >
        {children}
      </div>
    </div>
